 ...
 * Generated at: 2024-12-14 14:13:31 UTC
...
public final class masterinventorylist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/lib/jstl-impl-1.2.jar", Long.valueOf(1725112760000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    String searchKeyword = request.getParameter("searchKeyword");
      ...
      out.write("/css/Masterinventorylist.css\">\n");
 ...
 if (msg != null) { 
      ...
      out.write("/MasterinventoryList\" method=\"post\" >\n");
      out.write("\n");
      out.write("<header>\n");
 ...
 if (loginUser != null) { 
      out.write("\n");
      out.write("           		<button type=\"submit\" name=\"transition\" class=\"btn btn-primary custom-btn\" style=\"margin-bottom: 5px; padding-top: 1px; padding-bottom: 1px;\" id=\"MasterinventoryForm\"  value=\"MasterinventoryForm\">ﾏｽﾀｰﾃﾞｰﾀ登録</button>\n");
      out.write("            ");
 } 
      out.write("\n");
      out.write("    	</div>\n");
 ...
 if (loginUser != null) { 
      ...
      out.write("<form action=\"");
      out.print( request.getContextPath() );
      out.write("/MasterinventoryList\" method=\"GET\" class=\"mt-4 form-inline custom-margin\">\n");
 ...
 if (list != null && list.size() > 0) { 
      ...
      out.write("        <thead>\n");
      out.write("            <tr>\n");
      out.write("                <th>識別番号</th>\n");
      out.write("                <th>品名（Asplus)</th>\n");
      out.write("                <th>品番（Asplus)</th>\n");
      out.write("                <th>品名（Correction)</th>\n");
      out.write("                <th>品番（Correction)</th>\n");
      out.write("                <th>保管先</th>\n");
      out.write("                <th>在庫管理区分</th>\n");
      out.write("                <th>QRCode情報</th>\n");
      out.write("                <th>単価</th>\n");
      out.write("                <th></th>\n");
      out.write("            </tr>\n");
      out.write("        </thead>\n");
 ...
 for (Masterinventory m : list) { 
      ...
      out.write("                <tr>\n");
      out.write("                    <td>");
      out.print( m.getIdentificationnumber() );
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( m.getProductname_asplus() );
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( m.getProductnumber_asplus() );
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( m.getProductname_correction() );
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( m.getProductnumber_correction() );
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( m.getStoragelocation() );
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( m.getInventorymanagementclassification() );
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( m.getQrcodeinformation() );
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( m.getRate() );
      out.write("</td>\n");
      ...
      out.write("                    <a href=\"");
      out.print( request.getContextPath() );
      out.write("/MasterinventoryQRcode?action=qrcode&id=");
      out.print( String.valueOf(m.getId()) );
      out.write("\" class=\"btn btn-success\">QRcode</a>\n");
      out.write("                    ");
 if (loginUser != null) { 
      out.write("\n");
      out.write("                        <a href=\"");
      out.print( request.getContextPath() );
      out.write("/MasterinventoryForm?action=update&id=");
      out.print( String.valueOf(m.getId()) );
      out.write("\" class=\"btn btn-primary\">更新</a>\n");
      out.write("                        <a href=\"");
      out.print( request.getContextPath() );
      out.write("/MasterinventoryList?action=delete&id=");
      out.print( String.valueOf(m.getId()) );
      ...
      out.write("            <form action=\"");
      out.print( request.getContextPath() );
      out.write("/MasterinventoryList\" method=\"POST\" enctype=\"multipart/form-data\" class=\"form-inline\">\n");
      out.write("                <label for=\"csvFile\" class=\"mr-2\" style=\"margin-right: 5px; margin-bottom: 5px; padding-top: 1px; padding-bottom: 1px;\">CSVｲﾝﾎﾟｰﾄ:</label>\n");
      out.write("                <div class=\"form-group mr-2\">\n");
      out.write("                    <input type=\"file\" id=\"csvFile\" name=\"csvFile\" class=\"form-control-file\" style=\"margin-right: 5px; margin-bottom: 5px; padding-top: 1px; padding-bottom: 1px;\" multiple>\n");
      out.write("                </div>\n");
      ...
      out.write("  \n");
      out.write("<!-- QRcode制御 -->\n");
      out.write("  function openQRCodeWindow(id) {\n");
      out.write("      if (id) {\n");
      out.write("          var url = '");
      out.print( request.getContextPath() );
      out.write("/MasterinventoryQRcode?action=qrcode&id=' + id;\n");
      ...
      out.write("          window.open(url, 'QR Code', 'width=' + width + ',height=' + height + ',top=' + top + ',left=' + left);\n");
      out.write("      } else {\n");
      out.write("          alert('IDが無効です。');\n");
      out.write("      }\n");
      out.write("  }\n");
      out.write("</script>\n");
      out.write("</body>");
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/view/masterinventorylist.jsp(70,51) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/view/masterinventorylist.jsp(72,51) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
